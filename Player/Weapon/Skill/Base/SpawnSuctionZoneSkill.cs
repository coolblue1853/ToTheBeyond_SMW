...
public class SpawnSuctionZoneSkill : WeaponSkill
{
    // 적을 중앙으로 흡수하는 형태의 데미지존
    // 추후 일반 데미지존과 상속관계설정 필요 
    ...
    [SerializeField] private float _suctionForce = 5f;
    ...
    private void SpawnZone()
    {
        ...
        if (zone.TryGetComponent<SuctionDamageZoneEffect>(out var zoneEffect))
        {
            ...
            zoneEffect.SetSuction(_suctionForce);
        }
    }
}
